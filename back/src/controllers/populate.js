...
const { createLivrosQuery } = require("../models/livroModel");
const { createCliente } = require("../controllers/cliente");
  ...
  try {
    ...
    const usuariosCriados = await Promise.all(
      usuarios.map(async (user) => {
        ...
        const res = mockRes();
        //chamando a função devidamente para criar usuário (precisou mimetizar o req e res para que houvesse o hasheamento da senha)
